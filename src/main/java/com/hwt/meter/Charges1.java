 ...
 * @author HWT
 */
public class Charges1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Charges1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
